CS113-Git-2 พื้นฐานการใช้งาน Git ตอนที่ 2 Branch Merge Conflict

การสร้าง/แยก Branch

1. ให้ clone git repository จากคาบที่แล้ว มาทำงานต่อ
	git clone <git-url>
    อย่าลืมเปลี่ยน working directory
	cd git101

2. คำสั่งสำหรับการสร้าง Branch 
...
3. ตรวจสอบว่ามี Branch ใดบ้าง ด้วยคำสั่ง
	git branch
...
5. ตรวจสอบ Branch อีกรอบด้วยคำสั่ง
	git branch
...
11. เมื่อไม่มี conflict จะทำให้ git สร้าง commit ของการ merge นั้นไปเลย ดังนั้น เราจะต้องใส่ commit message ด้วย vi ถ้าใช้ default merge commit message ให้กด ESC แล้วพิมพ์ :wq! แล้วกด Enter
...
15. ให้ clone git repository มาไว้อีกเครื่องหนึ่ง หรือ directory ใหม่ เช่น git102
	cd ..
...
17. กลับมาที่เครื่องเก่า หรือ directory เก่า แล้ว pull การเปลี่ยนแปลงลงมาที่ local repository
	cd ..
	cd git101
...
18. สร้าง Branch feature2 และสลับไป Branch นั้นเลย ด้วยคำสั่ง
	git checkout -b feature2

19. ให้แก้ไฟล์ b.txt ใน branch feature2 และ master ในบรรทัดเดียวกัน ให้มีข้อความต่างกัน
...
21. เปิดไฟล์ b.txt ใน master จะเห็นว่า git สร้างข้อความที่อธิบาย conflict
...
22. หลังจากแก้ไข conflict เสร็จแล้ว ให้ commit การ merge นั้น
	git add b.txt
	git status
...
24. ในเครื่องใหม่ หรือ directory ใหม่ ให้แก้ไขข้อมูลใน new-1.txt แล้ว commit และ push ไปที่ github
	$ cd ..
	$ cd git102
	...
	$ git push origin master
$ git log --all --decorate --oneline --graph
25. ในเครื่องเก่า หรือ directory เก่า ให้แก้ไขข้อมูลใน new-1.txt บรรทัดเดียวกับข้อ 24 แล้ว commit
	$ cd ..
	$ cd git101
...
26. ก่อน Push ให้ Pull origin/master จะพบว่าการ Pull นี้ มี conflict เกิดขึ้น
...
27. ที่เครื่องใหม่ หรือ directory ใหม่ จะเห็นว่า Checkpoint ตามหลัง origin/master อยู่
	cd ..
	cd git102
	git log --all --decorate --oneline --graph
